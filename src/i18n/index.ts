...
/** Returns UI strings for the given locale, falling back to Portuguese first. */
export function useTranslations(locale: string = "pt-BR"): UIStrings {
  return translations[locale] ?? translations["pt-BR"] ?? translations["en"];
}
